...
<h1>Médias Aritméticas</h1>
    ...
    <input type="number" name="p2" id="p2" min="2" required value="<?=$peso2?>">
...
<li>A <strong>Média Aritmética Ponderada</strong> com pesos <?=$peso1?> e <?=$peso2?> é igual a <?=number_format($mp, 2, ",",
".")?>.</li>
</ul>
</section>
</body>
